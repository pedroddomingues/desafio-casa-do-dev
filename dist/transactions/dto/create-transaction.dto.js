...
__decorate(
	[
		(0, class_validator_1.ValidateIf)(
			(o) => o.type !== transaction_type_1.TransactionType.deposit
		),
...
__decorate(
	[
		(0, class_validator_1.ValidateIf)(
			(o) =>
				o.type === transaction_type_1.TransactionType.deposit ||
				o.type === transaction_type_1.TransactionType.transfer
		),
		(0, class_validator_1.IsString)(),
		(0, swagger_1.ApiPropertyOptional)(),
		__metadata("design:type", String),
...
__decorate(
	[
		(0, class_validator_1.ValidateIf)(
			(o) => o.type === transaction_type_1.TransactionType.payment
		),
		(0, class_validator_1.IsString)(),
		(0, swagger_1.ApiPropertyOptional)(),
		__metadata("design:type", String),
